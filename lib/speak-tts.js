...
var SpeakTTS = /*#__PURE__*/function () {
  function SpeakTTS() {
    ...
    _defineProperty(this, "utterances", []);

    _defineProperty(this, "currentUtterance", null);

    _defineProperty(this, "currentUtteranceIndex", null);
  ...
  _createClass(SpeakTTS, [{
    ...
    value: function speak(data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this3.utterances = [];
        var constUtterancesHolder = _this3.utterances;
        var reservedThis = _this3;
        ...
        sentences.forEach(function (sentence, index) {
          ...
          Object.keys(listeners).forEach(function (listener) {
            ...
            var newListener = function newListener(data) {
              ...
              if (listener === 'onerror') {
                // reservedThis.currentUtterance = utterance;
                reject({
                  constUtterancesHolder: constUtterancesHolder,
          ...
          _this3.utterances.push(utterance);
    ...
    key: "playFromIndex",
    value: function playFromIndex(data) {
      var _this4 = this;

      return new Promise(function (resolve, reject) {
        var index = data.index,
            _data$listeners2 = data.listeners,
            listeners = _data$listeners2 === void 0 ? {} : _data$listeners2,
            _data$queue2 = data.queue,
            queue = _data$queue2 === void 0 ? true : _data$queue2; // Stop current speech

        !queue && _this4.cancel();

        if (!_this4.utterances || _this4.utterances.length === 0 || index < 0 || index > _this4.utterances.length) {
          console.log(_this4.utterances, "Utterances");
          console.log(index, "Index");
          reject("Utterances is empty or index is out of range");
        }

        _this4.utterances.forEach(function (utterance, i) {
          if (i < index) {
            return;
          }
    ...
    key: "queueUtterances",
    value: function queueUtterances() {
      return this.utterances.length;
    }
  }, {
    key: "getCurrentUtterance",
    value: function getCurrentUtterance() {
      return this.currentUtterance;
    }
  }, {
    key: "getCurrentUtteranceIndex",
    value: function getCurrentUtteranceIndex() {
      var _this5 = this;
      ...
      return this.utterances.findIndex(function (row) {
        return row.text === _this5.currentUtterance.text;
      });
    }
  }]);
